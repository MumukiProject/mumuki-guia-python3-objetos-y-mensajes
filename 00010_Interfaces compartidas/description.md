[Anteriormente](../exercises/13151-programacion-con-objetos-objetos-y-mensajes-deje-su-mensaje) le pudimos enviar el mensaje `necesita_descanso` a los objetos `batman` y `superman`:
